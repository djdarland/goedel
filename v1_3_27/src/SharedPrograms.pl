...
'SharedPrograms.HeadAtom.P7'('MetaDefs.Atom.F2'(A,B), C, D, E, 'MetaDefs.Atom.F2'(A,F), G, H) :-
        ...
        user:goedel_freeze(ground([L]), (L=[],true->'SharedPrograms':'SharedPrograms.FixRationals.P2'(K,G),'SharedPrograms':'SharedPrograms.MeltTypeList.P4'(I,[],_,M),'SharedPrograms':'SharedPrograms.CheckHeadArgs.P4'(M,J,F,H);H=L)).
'~SharedPrograms.HeadAtom.P7'('MetaDefs.Atom.F2'(A,B), C, D, E, 'MetaDefs.Atom.F2'(A,F), G, H) :-
        '~SharedPrograms.PredicateInLanguage.P4'(A, C, _, I),
        '~SharedPrograms.MeltTypeList.P4'(I, [], _, J),
        '~SharedPrograms.MeltedArgumentTyping.P9'(J, B, C, D, E, F, K, [], L),
...
'SharedPrograms.StatementInLanguage.P5'('MetaDefs.<-''.F2'(A,B), C, 'MetaDefs.<-''.F2'(D,E), F, G) :-
        ...
        user:goedel_freeze(ground([J]), (J=[],true->'SharedPrograms':'SharedPrograms.FixRationals.P2'(I,K),'SharedPrograms':'SharedPrograms.HeadAtom.P7'(A,C,H,_,D,L,G),user:goedel_freeze(ground([G]),(G=[],true->'Integers':plus(K,L,M),F=M;true));G=J)).
'~SharedPrograms.StatementInLanguage.P5'('MetaDefs.<-''.F2'(A,B), C, 'MetaDefs.<-''.F2'(D,E), F, G) :-
        '~SharedPrograms.MeltedBodyTyping.P8'(B, C, [], H, E, I, [], J),
        user:goedel_freeze(ground([J]), (J=[],true->'SharedPrograms':'~SharedPrograms.FixRationals.P2'(I,K),'SharedPrograms':'~SharedPrograms.HeadAtom.P7'(A,C,H,_,D,L,G),user:goedel_freeze(ground([G]),(G=[],true->'Integers':plus(K,L,M),F=M;true));G=J)).
